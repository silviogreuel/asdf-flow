        ...
        public static ModelBuilder SeedFieldTemplates(this ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasData(
                    ...
                    new FieldTemplate() {Id = 9, NodeTemplateId = 3, Name = "Url", Type = typeof(String).FullName},
                    new FieldTemplate() {Id = 10, NodeTemplateId = 3, Name = "Content", Type = typeof(String).FullName},
                    new FieldTemplate() {Id = 11, NodeTemplateId = 3, Name = "Content-Type", Type = typeof(String).FullName}
            );
