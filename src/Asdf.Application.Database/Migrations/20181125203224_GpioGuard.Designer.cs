...
namespace Asdf.Application.Database.Migrations
{
    ...
    [Migration("20181125203224_GpioGuard")]
    partial class GpioGuard
    {
            ...
            modelBuilder.Entity("Asdf.Domain.Templates.FieldTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 22L, Name = "Name", NodeTemplateId = 7L, Type = "System.String" },
                        new { Id = 23L, Name = "Field", NodeTemplateId = 7L, Type = "System.String" }
                    );
                });
